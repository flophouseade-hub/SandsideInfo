...
<link href=\"../styleSheets/formPageFormatting.css\"rel=\"stylesheet\" type=\"text/css\">
  ...
  $outputString .= "\n<style>
  :root {
    --chosen-color: " . $pageColour . ";
    --chosen-color-lighter: " . $pageColours['lighter'] . ";
    --chosen-color-Comp1: " . $pageColours['splitComp1'] . ";
    --chosen-color-Comp2: " . $pageColours['splitComp2'] . ";
    --chosen-color-Comp1-lighter: " . $pageColours['splitComp1Lighter'] . ";
    --chosen-color-Comp2-lighter: " . $pageColours['splitComp2Lighter'] . ";
  }
  </style>";

  //$logOutLink = \"../LoginOrOut/logoutUserCode.php\";
  if (isset($_SESSION['currentUserFirstName']) && isset($_SESSION['currentUserLastName'])) {
    $outputString .= "<p class=\"loggedInAs\">logged in as: " . $_SESSION['currentUserFirstName'] . " " . $_SESSION['currentUserLastName'] . " " . "&nbsp;&nbsp;Access Level: " . $_SESSION['currentUserLogOnStatus'] . "</p>";
  } else {
...
function insertImageLibraryCard($imageID)
{
  ...
  $imageGroup = isset($_SESSION['imageLibrary'][$imageID]['ImageGroup']) && !empty($_SESSION['imageLibrary'][$imageID]['ImageGroup'])
