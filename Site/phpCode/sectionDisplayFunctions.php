...
function insertPageSectionOneColumn($contentString, $title, $sectionID)
{
  ...
  $_SESSION['sectionDB'][$sectionID]['SectionColour'] = $_SESSION['sectionDB'][$sectionID]['SectionColour'] ?? '#b3b3b3';
  ...
  if ($sectionID == 1002) { //temporary fix for unnumbered section getting wrong style
