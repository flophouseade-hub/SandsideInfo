...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['updateStudent'])) {
    ...
    if (count($errors) == 0) {
        ...
        if (!$connection) {
            ...
            $checkQuery = "SELECT StudentID FROM Students WHERE UPN = ? AND StudentID != ?";
            ...
            if ($result->num_rows > 0) {
                ...
                // Update student
                $updateQuery = "UPDATE Students SET FirstName = ?, LastName = ?, UPN = ?, Sex = ?, ClassID = ? WHERE StudentID = ?";
                ...
                if ($stmt->execute()) {
                    ...
                    $feedbackMessage = "<p style='color: red;'>ERROR: Could not update student. " . htmlspecialchars($stmt->error, ENT_QUOTES, 'UTF-8') . "</p>";
                }
            }
...
$query = "SELECT s.*, c.classname FROM Students s LEFT JOIN classes c ON s.ClassID = c.ClassID WHERE s.StudentID = ?";
...
<div class="formPageWrapper">
    <div class="formContainer">
        <h2>Edit Student: <?php echo htmlspecialchars($studentData['FirstName'] . ' ' . $studentData['LastName'], ENT_QUOTES, 'UTF-8'); ?></h2>
        ...
        <form method="POST" action="editStudentPage.php?editStudentID=<?php echo $editStudentID; ?>">
            ...
            <div class="formField">
                ...
                <input type="text" id="firstName" name="firstName" class="formInput" 
                       value="<?php echo isset($_POST['firstName']) ? htmlspecialchars($_POST['firstName'], ENT_QUOTES, 'UTF-8') : htmlspecialchars($studentData['FirstName'], ENT_QUOTES, 'UTF-8'); ?>" 
                       required>
            </div>
            ...
            <div class="formField">
                ...
                <input type="text" id="lastName" name="lastName" class="formInput" 
                       value="<?php echo isset($_POST['lastName']) ? htmlspecialchars($_POST['lastName'], ENT_QUOTES, 'UTF-8') : htmlspecialchars($studentData['LastName'], ENT_QUOTES, 'UTF-8'); ?>" 
                       required>
            </div>
            ...
            <div class="formField">
                ...
                <input type="text" id="upn" name="upn" class="formInput" 
                       value="<?php echo isset($_POST['upn']) ? htmlspecialchars($_POST['upn'], ENT_QUOTES, 'UTF-8') : htmlspecialchars($studentData['UPN'], ENT_QUOTES, 'UTF-8'); ?>" 
                       required>
            ...
            <div class="formField">
                ...
                <select id="sex" name="sex" class="formSelect" required>
                    ...
                    <?php
                    $currentSex = isset($_POST['sex']) ? $_POST['sex'] : $studentData['Sex'];
                    ?>
