		...
		if (!$connection) {
			...
			if ($result->num_rows > 0) {
				...
				if ($stmt->execute()) {
					...
					$feedbackMessage =
						"<p style='color: red;'>ERROR: Could not add student. " .
        ...
        <form method="POST" action="addNewStudentPage.php">
            ...
            <div class="formField">
                ...
                <select id="sex" name="sex" class="formSelect" required>
                    ...
                    <option value="Male" <?php echo isset($_POST["sex"]) && $_POST["sex"] == "Male"
                    	? "selected"
                    	: ""; ?>>Male</option>
                    <option value="Female" <?php echo isset($_POST["sex"]) && $_POST["sex"] == "Female"
                    	? "selected"
                    	: ""; ?>>Female</option>
                </select>
            </div>
            ...
            <div class="formField">
                ...
                <select id="classID" name="classID" class="formSelect">
                    ...
                    <?php foreach ($allClasses as $class) {
                    	$selected =
                    		isset($_POST["classID"]) && $_POST["classID"] == $class["ClassID"] ? "selected" : "";
