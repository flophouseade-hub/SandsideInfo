...
// Get user details
$userQuery = "SELECT FirstName, LastName FROM UsersDB WHERE UsersID = ?";
...
// Get course details
$courseQuery = "SELECT CourseName, CourseDescription FROM CoursesDB WHERE CourseID = ?";
...
$logoQuery = "SELECT ImageLink FROM ImageLibrary WHERE ImageID = 13";
